    ...
    <div className='grid lg:grid-cols-4 xl:grid-cols-6 min-h-screen '>
     ...
     <main className='lg:col-span-3 xl:col-span-5 bg-gray-100 p-8 '>
      <div className='flex justify-center pt-5'>
       ...
       <section className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 mt-10 pt-[80px] '>


        {/* Card 1 */} 
        <div className='bg-sidebar-100 pt-[60px] rounded-xl text-white flex items-center flex-col gap-6 w-66 h-[350px] drop-shadow-2xl'>
      ...
      <div>
        ...
        {/* Card 2 */}
        <div className='col-span-3 xl:col-span-2 flex flex-col items-center '>
  <div className='w-[450px] '>
    ...
    <ul className='w-full overflow-y-auto max-h-[315px]'>
      {recordatorios.map(recordatorio => (
        <li key={recordatorio._id} className='bg-white pl-12 pr-12 p-4 mb-4 rounded flex justify-between items-center shadow-lg'>
          <div>
     ...
     <div className="p-6 bg-gray-800 text-white rounded-xl w-64 h-[350px] shadow-xl ">
