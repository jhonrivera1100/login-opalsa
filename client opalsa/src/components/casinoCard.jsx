...
function CasinoCard({ casino }) {
  return (
    <div className="w-full max-w-sm bg-white border border-gray-200 my-1 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-900 transition-colors duration-300">
