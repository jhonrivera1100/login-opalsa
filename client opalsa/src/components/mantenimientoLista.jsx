    ...
    <div className="max-w-7xl mx-auto mt-10 p-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8">
        {mantenimientos.map((mantenimiento) => (
          <div key={mantenimiento._id} className="relative bg-white py-6 px-6 rounded-3xl w-80 shadow-xl">
            ...
            <div className="mt-8">
              ...
              <div className="my-2">
                ...
                >
                  {mantenimiento.descripcion.length > 40
                    ? `${mantenimiento.descripcion.substring(0, 40)}...`
